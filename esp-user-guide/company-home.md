...
You can access Hornbill using any web browser. Navigate to `login.hornbill.com/<Your_Instance>`. If you don't know your instance name, contact your IT support team.
